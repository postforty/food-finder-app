...
import { crawlAndSaveRestaurant, getRestaurant, updateRestaurant } from '@/app/actions/restaurant-actions'; // Server Actions
...
export default function EditRestaurantPage() {
            ...
            try {
                ...
                if (res.success && res.data) {
                    setFormData({
                        ...
                        blogReviews: res.data.blogReviews || '',
                    });
                } else {
    ...
    const handleReCrawl = async () => {
        ...
        if (!confirm('정말 다시 크롤링하시겠습니까? 기존 정보가 덮어씌워질 수 있습니다.')) return;
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <p className="text-xs text-gray-500 mb-4 leading-relaxed">
                                URL을 변경했거나 최신 정보로 업데이트하려면 아래 버튼을 누르세요.
                            </p>
                            <div className="mb-4">
                                <label className="block text-xs font-medium text-gray-500 mb-1">네이버 지도 URL</label>
                                <input 
                                    type="text" 
                                    name="mapUrl" 
                         ...
                         <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                            <form onSubmit={handleManualSubmit} className="space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                 ...
                                 <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">방문자 리뷰 수</label>
                                        <input 
                                            type="text" 
                                            name="reviews"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">블로그 리뷰 수</label>
                                        <input 
                                            type="text" 
                                            name="blogReviews"
                                ...
                                <div className="pt-4 flex items-center justify-end space-x-3">
                                    ...
                                    <button 
                                        ...
                                        className={`px-5 py-2.5 rounded-lg text-white font-medium shadow-md transition-all ${
                                            saving ? 'bg-orange-300 cursor-not-allowed' : 'bg-orange-500 hover:bg-orange-600 hover:shadow-lg'
                                        }`}
                                    >
                                        {saving ? '저장 중...' : '수정사항 저장'}
                                    </button>
