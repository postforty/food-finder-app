  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--surface)] via-[var(--background)] to-[var(--surface)] px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-[var(--accent)] rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-float" style={{ animationDelay: "2s" }}></div>
      </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--foreground-muted)]">
                    Food Finder 백오피스에 접근하려면 Google 계정으로 로그인해주세요.
                  </p>
                </div>
              </div>
            </div>
